...
# Modified by Trefex <trefex@gmail.com>  (c) 2014
# Change log:
# 	2014-10-28
#		- Changed some formatting options
#		- Added option to set PGPASSWORD 
#		- Chaned pg_dump to use custom format instead of SQL
#
...
# Uncomment the following line if you need to provide a PG Password
#export PGPASSWORD=specialpwd
...
MAILADDR="root@yourorganization.org"
...
dbdump () {
pg_dump --username=$USERNAME --format=c --file=$2 $HOST $OPT $1
return 0
}
...
echo -e "======================================================================\n"
echo -e "AutoPostgreSQLBackup VER $VER\n"
#printf "\r\n"
echo -e "Backup of Database Server - $DBHOST \n"
echo -e "======================================================================\n"
